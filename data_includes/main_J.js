...
PennController( "instructions2" ,
    ...
    .log("sentence_rating", "instructions2")
...
PennController.Template( PennController.GetTable( "Crit_Stimuli_HistLifetime.csv")
                         ...
                         variable => ["critical",
                                      ...
                                      newText("yes_text", "<i>(yes)")
                                      .settings.css("font-size", "20px")
                                      //.print("39vw","40vh") // F-version
                                      .print("58vw","40vh") // J-version
                                      .settings.color("green")
                                      ,
                                      newText("J_text", "J")
                                      .settings.css("font-size", "20px")
                                      ...
                                      .settings.css("font-size", "20px")
                                      .settings.center()
                                      //.print("58vw","40vh") // F-version
                                      .print("39vw","40vh") // J-version
                                      .settings.color("red")
                                      ,
                                      newKey("sentence_rating", "FJ")
                                      .callback( getTimer("time_out1").stop() )
                                      ...
                                      .disable()
                                      ,
                                      newVar("sentence_rating") // this will create a new variable "sentence_rating"
                                      .set(getKey("sentence_rating") )
...
PennController. Template( PennController.GetTable( "Crit_Stimuli_HistLifetime.csv")// change this line for the appropriate experimental list
                          ...
                          variable => ["post_task_prac",
                                       "PennController", PennController(
                                           ...
                                           .add("center at 30%", "center at 39%", getText("no_text"))// J-version
                                           //.add("center at 70%", "center at 39%", getText("no_text"))// F-version
                                           .add("center at 70%", "center at 39%", getText("yes_text"))// J-version                                                                                   
                                           .print()
                                           ,
...
PennController. Template( PennController.GetTable( "Crit_Stimuli_HistLifetime.csv")// change this line for the appropriate experimental list
                          ...
                          variable => ["post_task",
                                       "PennController", PennController(
                                           ...
                                           // NAME
                                           newCanvas("name", "70vw" , "70vh")
                                           .add("center at 50%", "center at 22%", getText("post_name"))
                                           .add( "center at 30%", "center at 35%", getText("F_text"))
                                           .add( "center at 70%", "center at 35%", getText("J_text"))
                                           //.add("center at 30%", "center at 28%", getText("yes_text_familiar"))// F-version
                                           .add("center at 30%", "center at 28%", getText("no_text_unfamiliar"))// J-version
                                           //.add("center at 70%", "center at 28%", getText("no_text_unfamiliar"))// F-version
                                           .add("center at 70%", "center at 28%", getText("yes_text_familiar"))// J-version                                                                                   
                                           .print()
                                           ,
                                           newSelector("post_name")
                                           .add( getText("F_text"),getText("J_text"))
                                           ...
                                           // NATIONALITY
                                           newCanvas("nationality", "70vw" , "70vh")
                                           .add("center at 50%", "center at 22%", newText("nationality...")
                                                .settings.css("font-size", "20px"))
                                           .add( "center at 30%", "center at 28%", getText("nationality_correct"))
                                           .add( "center at 70%", "center at 28%", getText("nationality_incorrect"))
                                           .add("center at 30%", "center at 35%", getText("F_text") )
                                           ...
                                           // OCCUPATIION
                                           newCanvas("occupation", "70vw" , "70vh")
                                           .add("center at 50%", "center at 22%", newText("most known as a(n)...")
                                                .settings.css("font-size", "20px"))
                                           .add(  "center at 30%", "center at 28%", getText("occupation_correct"))
                                           .add("center at 70%", "center at 28%", getText("occupation_incorrect"))
                                           .add("center at 30%", "center at 35%", getText("F_text") )
